...
<html>
	...
	<body>
		...
		<form name="mainform"   action="loginServlet" method="post">
		...
		<%
			...
			String sql3="SELECT username,password FROM users Order By registTime desc";
			...
			while(resultset.next()){
				...
				if(s.equals(account) && ps.equals(newPasw)){		//成功登录
					response.sendRedirect("http://172.31.75.246/S2014150305/welcome.jsp");
